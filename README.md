...
Foi observada a correlação entre a classe no navio e a tarifa paga pela pessoa passageira através de um gráfico de violino. O Titanic tinha três classes: primeira, segunda e terceira classe. Em média, a tarifa paga pelas pessoas viajantes da primeira classe foi significativamente mais alta do que a tarifa paga pelas pessoas viajantes da segunda e terceira classes: a tarifa média da primeira classe foi de aproximadamente 84 dólares, enquanto a tarifa média da segunda classe foi de cerca de 20 dólares e a da terceira classe de 13 dólares.
